...
Parsley.addMessages('ms', {
  ...
  mincheck:       "Kamu mesti memilih sekurang-kurangnya %s pilihan.",
  maxcheck:       "Kamu tidak boleh memilih lebih daripada %s pilihan.",
  check:          "Kamu mesti memilih diantara %s hingga %s pilihan.",
